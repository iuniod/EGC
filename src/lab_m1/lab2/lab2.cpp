...
void Lab2::Init()
{
    ...
    // opposing vertex orientations.
    {
        ...
        {
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2, 1, 1), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 2, 2), glm::vec3(1, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(1.5f, 0.5f, 1.5f), glm::vec3(0.5f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(1.5f, 0.5f, -1.5f), glm::vec3(0.5f));
